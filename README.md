...
!\> The GRIP documentation explains that the dataset is for 'global environmental and biodiversity modelling projects. The dataset is not suitable for navigation.' Therefore, please upload your own, high-quality roads dataset to the App for local analyses.
